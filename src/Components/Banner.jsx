        ...
        <div className="w-full h-96">
            ...
            <div className='mx-4'>
                ...
                <div className='w-[max-content] mx-auto'>{
                      !user? <Link to='/register'><button className='btn btn-outline bg-orange-700 text-white'>Let' Explore</button></Link> : <Link to='/'><button className='btn btn-outline bg-orange-700 text-white'>Let' Explore</button></Link>
